...
/**
 * GET /api/data/guacamole?client=XXX
 * Returns Guacamole host information for a specific client
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const activeData = await readMigratedDataset("guacamoleHosts", client);
