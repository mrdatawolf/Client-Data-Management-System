...
- `docs/PROJECT.md` and `docs/ARCHITECTURE.md` describe what this system is and
...
This handbook (and the process it describes) was adopted from the sister
"Project Template DbC" repository. See that template's `docs/AI_DEVELOPMENT_SYSTEM.md`
for the full rationale if you need it; this repository's own copy under `docs/`
is the authoritative one for day-to-day work here.
